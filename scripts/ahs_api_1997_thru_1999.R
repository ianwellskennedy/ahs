...
data_2001_2023_file_path <- "S:/BuildingProducts/AHS Historical Data/Cleaned Project Level AHS Files/ahs_data_2001_to_2023_project_level.xlsx"
output_file_path <- "S:/BuildingProducts/AHS Historical Data/Cleaned Project Level AHS Files/ahs_data_1997_to_2023_project_level.xlsx"

# Set the file path to the folder that contains all yearly AHS data folders you are interested in
folder_location <- "S:/BuildingProducts/AHS Historical Data/Raw AHS Files/97_99"
folder_location
